    ...
    return (
      <div className="min-h-screen bg-base-200 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-base-content/60">Checking system status...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="card-body">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-semibold text-base-content">
              {isInitMode ? 'Initialize Admin Account' : 'Admin Login'}
            </h2>
            {isInitMode && (
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">
                  ...
                  {isInitMode ? 'Create Password' : 'Password'}
                </span>
              </label>
              <input
                type="password"
                className="input input-bordered"
                placeholder={isInitMode ? 'Enter a strong password' : 'Enter your password'}
                value={password}
            ...
            >
              {isLoading ? (
                <span className="flex items-center gap-2">
                  ...
                  {isInitMode ? 'Creating Account...' : 'Logging in...'}
                </span>
              ) : (
                <span className="flex items-center gap-2">
                  {isInitMode ? (
          ...
          {isInitMode && (
            <div className="mt-6 p-4 bg-base-200 rounded-lg">
              <p className="text-sm text-base-content/70">
                ...
                <strong>First time setup:</strong> This password will be used to access the admin panel. 
                Please keep it secure and remember it.
              </p>
            </div>
          )}
