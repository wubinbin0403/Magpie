        ...
        .values([
          {
            ...
            domain: 'example.com',
            title: 'First Link',
            userDescription: 'First description',
            userCategory: 'tech',
            userTags: JSON.stringify(['tag1']),
            status: 'published',
            publishedAt: earlier,
            createdAt: earlier,
          },
          {
            ...
            domain: 'example.com',
            title: 'Latest Link',
            userDescription: 'Latest description',
            userCategory: 'tech',
            userTags: JSON.stringify(['tag2']),
            status: 'published',
            publishedAt: now,
            createdAt: now,
          },
