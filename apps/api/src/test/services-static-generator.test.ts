    ...
    await testDrizzle.insert(links).values([
      {
        ...
        finalDescription: 'This is a test article about technology',
        finalCategory: '技术',
        finalTags: JSON.stringify(['tech', 'test']),
        status: 'published',
        createdAt: now - 3600,
      ...
      },
      {
        ...
        finalDescription: 'Another test article about design',
        finalCategory: '设计',
      ...
      },
      {
        ...
        domain: 'example.com',
        title: 'Draft Article',
        finalDescription: 'This is a draft',
        finalCategory: '其他',
        status: 'pending',
        createdAt: now,
      ...
      await testDrizzle.insert(links).values([
        {
          ...
          finalDescription: 'Description with & < > " \' characters',
          finalCategory: 'Test & Debug',
          finalTags: JSON.stringify(['test&debug']),
          status: 'published',
          createdAt: now,
          publishedAt: now,
